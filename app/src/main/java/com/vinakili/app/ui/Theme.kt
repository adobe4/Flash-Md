...
// Vinakili palette — deliberately no green, no purple anywhere.
...
val DarkB = BColors(
    ...
    glassHi = Color(0xE61E2939),
    glassLo = Color(0xCC131A28),
    glassEdge = Color(0x2EFFFFFF),
    glassEdgeDim = Color(0x08FFFFFF),
    shadowTint = Color(0xCC000000),
)
...
val LightB = BColors(
    ...
    glassHi = Color(0xF2FFFFFF),
    glassLo = Color(0xD9F2F5FA),
    glassEdge = Color(0xE6FFFFFF),
    glassEdgeDim = Color(0x40FFFFFF),
    shadowTint = Color(0x40384863),
)
...
@Composable
fun VinakiliTheme(dark: Boolean = isSystemInDarkTheme(), business: Boolean = false, content: @Composable () -> Unit) {
